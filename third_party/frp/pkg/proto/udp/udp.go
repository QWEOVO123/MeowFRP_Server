...
func ForwardUserConn(udpConn *net.UDPConn, readCh <-chan *msg.UDPPacket, sendCh chan<- *msg.UDPPacket, bufSize int) {
	ForwardUserConnWithFilter(udpConn, readCh, sendCh, bufSize, nil)
}

func ForwardUserConnWithFilter(udpConn *net.UDPConn, readCh <-chan *msg.UDPPacket, sendCh chan<- *msg.UDPPacket, bufSize int, filter func(*msg.UDPPacket) bool) {
	// read
	go func() {
